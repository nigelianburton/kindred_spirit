"""
Test the Nigel values LoRA adapter with various scenarios.
Usage: conda activate train_for_nigel && python test_nigel_adapter.py
"""
...
def run_tests(model, tokenizer):
    ...
    test_scenarios = [
        ...
        {
            "name": "General Knowledge (No Forgetting Check)",
            "prompt": "What is the capital of France?"
        },
        {
            "name": "Math (No Forgetting Check)",
            "prompt": "Calculate 15% of 240."
        }
    ]
    
    print("=" * 80)
    print("TESTING NIGEL VALUES ADAPTER")
    print("=" * 80)
    print()
...
def interactive_mode(model, tokenizer):
    ...
    print("\n" + "="*80)
    print("INTERACTIVE MODE - Chat with Nigel-tuned model")
